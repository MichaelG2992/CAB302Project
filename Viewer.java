...
import server.Billboard;        //SERVER INCLUDED
...
public class Viewer {
    ...
    private static Billboard billboard = null; //SERVER INCLUDED
    ...
    public static void createServerConnection() throws FileNotFoundException {
        ...
        try {
            ...
            BillboardRequest billboardRequest = new BillboardRequest(); //SERVER INCLUDED
            objectOutputStream.writeObject(billboardRequest); //SERVER INCLUDED


            Object o = objectInputStream.readObject();

            if (o instanceof Billboard) {
                billboard = (Billboard) o; //SERVER INCLUDED
    ...
    public static String billboardFile(){
        if (gotBillboard){
            return billboard.getXmlString();    //SERVER INCLUDED
        }
        else return "";
    }

    public static  void showBillboard(JFrame frame, JPanel panel){
        //create dimensions for placement UI
        Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
        int screenHeight = screenSize.height;
        int screenWidth = screenSize.width;

        Dimension halfSize = new Dimension(screenWidth, screenHeight/2);
        ...
        if(billboardFile().contains("<picture")){
            ...
            imageLabel.setPreferredSize(screenSize);
            ...
            sizedImageLabel = new JLabel(new ImageIcon(sizedImage), SwingConstants.CENTER);
            sizedImageLabel.setMaximumSize(screenSize);
            sizedImageLabel.setPreferredSize(imagePlusOne);
        }
        ...
        //setup the frame and place billboard into it
        ...
        if(messageLabel != null){
            if(imageLabel == null && infoLabel == null){
                messageLabel.setPreferredSize(screenSize);
            }
        ...
        if(infoLabel != null){
            if(imageLabel == null && messageLabel == null){
                infoLabel.setPreferredSize(onlyInfo);
        ...
        if(imageLabel == null && messageLabel == null && infoLabel == null){
            ...
            failed.setPreferredSize(screenSize);
    ...
    public static void main(String args[]) {
        ...
        Timer t = new Timer(15000, checkConnection);
        t.setRepeats(true);
        t.start();
